...
class _IngredientPickerDialogState extends State<IngredientPickerDialog> {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                      '${food.category} • ${food.calories.toInt()} kcal / 100g',
                    ),
                    trailing: const Icon(
  ...
  void _promptAmount(BuildContext context, FoodModel food) {
    final TextEditingController amountCtrl = TextEditingController(
      text: food.defaultServingSize.toInt().toString(),
    );
    showDialog(
      context: context,
      builder:
