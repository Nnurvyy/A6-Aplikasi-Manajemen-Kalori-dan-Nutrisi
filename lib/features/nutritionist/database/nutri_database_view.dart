...
class NutritionistFoodDatabaseView extends StatefulWidget {
  ...
  @override
  State<NutritionistFoodDatabaseView> createState() => _NutritionistFoodDatabaseViewState();
}

class _NutritionistFoodDatabaseViewState extends State<NutritionistFoodDatabaseView> {
  ...
  void _navigateToEdit(FoodModel food) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AdminFoodFormView(initialFood: food),
      ),
    );
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                // FIX: Gunakan withAlpha atau withValues untuk Flutter baru
          ...
          Padding(
            ...
            child: Row(
              children: [
                const Icon(Icons.filter_alt_outlined, color: _primary, size: 18),
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        // FIX: Tambahkan <String> pada map
                        items: _filterCategories.map<DropdownMenuItem<String>>((String cat) {
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: const Row(
                      children: [
                        Icon(Icons.edit_rounded, color: Colors.blue, size: 12),
                        SizedBox(width: 4),
                        Text(
                          'Edit',
                          style: TextStyle(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(
          icon,
          size: 20,
          color: enabled ? _primary : _textMuted.withAlpha(50),
        ),
      ),
    );
  }
  ...
  Widget _buildEmptyState() {
    return const Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.search_off_rounded, size: 48, color: Color(0xFFE0E0E0)),
          SizedBox(height: 12),
          Text(
