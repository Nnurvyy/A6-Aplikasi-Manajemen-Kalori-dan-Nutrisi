...
import 'package:nutritrack_app/features/user/dashboard/views/dashboard_view.dart';
import 'package:nutritrack_app/features/user/profile/views/profile_view.dart';
import 'package:nutritrack_app/features/user/scan/views/scan_view.dart';
import 'package:nutritrack_app/features/user/scan/controllers/scan_controller.dart';
import 'package:nutritrack_app/features/user/scan/views/scan_gemini_view.dart';
import 'package:nutritrack_app/features/user/scan/controllers/scan_gemini_controller.dart';
import 'package:nutritrack_app/features/general/submission/views/submission_screen.dart';
import 'package:nutritrack_app/features/general/food/views/food_list_view.dart';
import 'package:nutritrack_app/features/user/manual_food/views/manual_food_selection_view.dart';
...
import 'package:nutritrack_app/features/general/food/views/watchlist_view.dart';
import 'package:nutritrack_app/features/general/food/views/food_detail_view.dart';
import 'package:nutritrack_app/features/user/progress/views/progress_view.dart';
...
class _UserMainViewState extends State<UserMainView>
  ...
  static const List<_NavItem> _navItemsNormal = [
    ...
    _NavItem(icon: Icons.note_alt_rounded, label: 'Pengajuan'),
    _NavItem(icon: Icons.tag_faces_rounded, label: 'Profile'),
  ];
  ...
  late final AnimationController _item5Ctrl; // Scan Gemini
  ...
  static const List<_DialItemData> _dialItems = [
    _DialItemData(
      ...
      label: 'Scan Makanan (Gemini)',
      sublabel: 'Analisis komponen dengan Gemini AI (Online)',
    ...
    _DialItemData(
      ...
      sublabel: 'Cari makanan di database, dilengkapi pencarian dengan AI',
    ...
    _DialItemData(
      ...
      label: 'Scan Makanan (YOLO)',
      sublabel: 'Deteksi otomatis (Offline)',
  ...
  void initState() {
    ...
    _item5Ctrl = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 350),
    );
    ...
    switch (tag) {
      ...
      case 'scan_gemini':
        Navigator.of(context).push(
          _upRoute(
            ChangeNotifierProvider(
              create: (_) => ScanGeminiController(),
              child: const ScanGeminiView(),
            ),
          ),
        );
        break;
      case 'saved':
        ...
        break;
      case 'db':
        Navigator.of(context).push(_upRoute(const FoodListView()));
        break;
      case 'manual':
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _DialCard(
                    data: _dialItems[5],
                    ctrl: _item5Ctrl,
                    onTap: () => _onDialItemTap(_dialItems[5].tag),
                  ),
                ],
              ),
            ),
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        height: 64, // Tinggi area hijau navbar disesuaikan agar pas dan enak dilihat
        child: SafeArea(
          top: false,
          bottom: false,
          child: Row(
