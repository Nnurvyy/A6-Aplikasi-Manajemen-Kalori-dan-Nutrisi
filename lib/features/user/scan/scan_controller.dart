...
class ScanController extends ChangeNotifier {
  ...
  Future<bool> saveScanResult({
    ...
    if (_processedImageBytes == null || _mappedFoods.isEmpty) return false;

    try {
      // 1. Simpan gambar PCD ke lokal secara offline-first
      final String? localFileName = await OfflineStorageService.saveLocalImage(_processedImageBytes!);
