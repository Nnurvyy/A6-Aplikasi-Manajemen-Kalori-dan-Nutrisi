...
class PCDHelper {
  ...
  static Future<String?> autoCropAndEnhance(
    String imagePath, {
    ...
    try {
      ...
      String outPath =
          '${directory.path}/processed_nutrition_${DateTime.now().millisecondsSinceEpoch}.jpg';
  ...
  static Future<Uint8List?> drawHighlights(
    String imagePath,
    List<Rect> rects,
  ) async {
    return await compute(
      (Map<String, dynamic> args) {
        ...
        final color = img.ColorRgba8(
          ...
          0,
          100,
        ); // Semi-transparent green if supported, else solid
